...
print("Kenny chatbot has been activated. (type 'exit' to quit)")
...
while True:
    ...
    if best_match and score >= threshold:
        ...
        print("Kenny:", response)
        last_response = response

    else:
        response = input("Sorry I don't understand... ")
    ...
    conversation_history.append({"user": normalize_input(user_input), "Kenny": response})
